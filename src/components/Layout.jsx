...
import { LayoutDashboard, Users, Truck, FileBox, ShoppingBag, FileText, Receipt, Menu, X, UserCog, LogOut, TrendingUp } from 'lucide-react';
    ...
    <div className="app-container">
      <aside className={`sidebar ${sidebarOpen ? 'open' : ''}`}>
        ...
        <nav className="sidebar-nav">
          ...
          <NavLink onClick={() => setSidebarOpen(false)} to="/admin/profitability" className={({ isActive }) => `nav-item ${isActive ? 'active' : ''}`}>
