  ...
  return <>
    ...
    {view === 'sales' && <section className="executive-dashboard-view">
      ...
      <div className="executive-kpis">
        ...
        <Kpi icon={<Sprout />} label="Costes de producción" value={money(data.productionExpenses)} detail={`Cultivo ${money(data.seedExpenses + data.substrateExpenses)} · táperes ${money(data.packagingExpenses)} · etiquetas ${money(data.labelExpenses)}`} tone="amber" onClick={() => openFinancial('harvests')} />
