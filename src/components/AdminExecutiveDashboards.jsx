  ...
  return <>
    ...
    {view === 'sales' && <section className="executive-dashboard-view">
      ...
      <div className="executive-kpis">
        ...
        <Kpi icon={<Sprout />} label="Costes de producción" value={money(productionTotal)} detail={`Cultivo imputado a cosecha ${money(data.activeHarvestCostInPeriod + data.seedExpenses + data.substrateExpenses)} · envases ${money(data.packagingExpenses)} · etiquetas ${money(data.labelExpenses)}`} tone="amber" onClick={() => openFinancial('harvests')} />
