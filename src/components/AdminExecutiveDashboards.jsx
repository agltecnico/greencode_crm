  ...
  return <>
    ...
    {view === 'sales' && <section className="executive-dashboard-view">
      ...
      <div className="executive-kpis">
        <Kpi icon={<Sprout />} label="Coste de producción vendido" value={money(data.totalCost)} detail={`${data.costedUnits} túperes vendidos con coste trazado · ${data.costCoverage.toFixed(1)} % de cobertura`} tone="amber" onClick={() => openFinancial('profit-products')} />
